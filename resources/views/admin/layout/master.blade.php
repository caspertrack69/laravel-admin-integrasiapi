...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <title>ngoding kok template</title>
        <meta name="description" content="ngoding kok template" />
            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./"
                        ><img src="images/33.png" alt="Logo"
                    /></a>
                    ...
                    <section class="card">
                        <div class="twt-feed blue-bg">
                            ...
                            <div class="media">
                                <a href="#">
                                    <img
                                        class="align-self-center rounded-circle mr-5"
                                ...
                                <div class="media-body">
                                    <h2 class="text-white display-6">Rohman</h2>
                                    <p class="text-light">Bukan Web Designer</p>
                                </div>
                            </div>
                        </div>
