            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="sandi" class="col-md-4 col-form-label text-md-right">{{ __('sandi') }}</label>

                            <div class="col-md-6">
                                <input id="sandi" type="password" class="form-control @error('sandi') is-invalid @enderror" name="sandi" required autocomplete="sandi-baru">
